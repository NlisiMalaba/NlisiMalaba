...
Dedicated to building high-performance applications and optimizing technical workflows. 
I specialize in scalable backend architectures with .NET, Go, and Spring Boot, modern web experiences with Angular/Next.js, and cross-platform mobile development with Flutter.
...
| :--- | :--- | :--- | :--- |
| **Zimbabwe Marketplace** | E-commerce | `.NET`, `Next.js`, `SQL Server` | ![In Progress](https://img.shields.io/badge/Status-Active-success) |
| **Online Healthcare** | Telemedicine | `Go`, `Angular`, `Postgres` | ![In Progress](https://img.shields.io/badge/Status-Developing-yellow) |
| **eLearning Platform** | Education | `.NET`, `Next.js`, `Angular` | ![In Progress](https://img.shields.io/badge/Status-Active-success) |
| **Client Portal** | Enterprise Tools | `Next.js`, `.NET`, `Redis` | ![In Progress](https://img.shields.io/badge/Status-In_Progress-yellow) |
